...
export default function MainHero({phoneNumber}: Props): JSX.Element  {
   const whatsappUrl = JSON.stringify(`https://api.whatsapp.com/send?phone=${phoneNumber}&text=Hi`)
  return (
   ...
   <div className="hero">
       <div className="hero_txt">
           ...
           <h1>Next-Level Marketing Collaboration</h1>
           ...
           <p>
               ...
               <div className="hero_btn">
                   <a className="hero_url" target="_blank" href={whatsappUrl}>
